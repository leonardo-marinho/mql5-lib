...
//| Get close value                                                  |
//+------------------------------------------------------------------+
double CBar::Close(int t_shift = 0)
{
  //--- return close value
...
//| Get high value                                                   |
//+------------------------------------------------------------------+
double CBar::High(int t_shift = 0)
{
  //--- return high value
...
//| Get open value                                                   |
//+------------------------------------------------------------------+
double CBar::Open(int t_shift = 0)
{
  //--- return open value
...
//| Get price change                                                 |
//+------------------------------------------------------------------+
double CBar::PriceChange(int t_shift = 0)
{
...
//| Get volume                                                       |
//+------------------------------------------------------------------+
long CBar::Volume(int t_shift = 0)
{
  //--- return volume value
...
//| Get tick volume                                                  |
//+------------------------------------------------------------------+
long CBar::TickVolume(int t_shift = 0)
{
...
//| Get real volume                                                  |
//+------------------------------------------------------------------+
long CBar::RealVolume(int t_shift = 0)
{
...
//| Get spread                                                       |
//+------------------------------------------------------------------+
long CBar::Spread(int t_shift = 0)
{
  //--- return spread value
...
//| Get time                                                         |
//+------------------------------------------------------------------+
datetime CBar::Time(int t_shift = 0)
{
  //--- return open time
